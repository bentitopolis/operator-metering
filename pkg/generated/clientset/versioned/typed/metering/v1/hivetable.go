...
func (c *hiveTables) Get(name string, options metav1.GetOptions) (result *v1.HiveTable, err error) {
	result = &v1.HiveTable{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("hivetables").
...
func (c *hiveTables) Watch(opts metav1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *hiveTables) Create(hiveTable *v1.HiveTable) (result *v1.HiveTable, err error) {
	result = &v1.HiveTable{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("hivetables").
...
func (c *hiveTables) Update(hiveTable *v1.HiveTable) (result *v1.HiveTable, err error) {
	result = &v1.HiveTable{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("hivetables").
...
func (c *hiveTables) UpdateStatus(hiveTable *v1.HiveTable) (result *v1.HiveTable, err error) {
	result = &v1.HiveTable{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("hivetables").
...
func (c *hiveTables) Delete(name string, options *metav1.DeleteOptions) error {
...
func (c *hiveTables) DeleteCollection(options *metav1.DeleteOptions, listOptions metav1.ListOptions) error {
	var timeout time.Duration
...
func (c *hiveTables) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1.HiveTable, err error) {
	result = &v1.HiveTable{}
