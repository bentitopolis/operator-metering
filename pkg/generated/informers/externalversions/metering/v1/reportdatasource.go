...
import (
	...
	versioned "github.com/bentitopolis/operator-metering/pkg/generated/clientset/versioned"
	internalinterfaces "github.com/bentitopolis/operator-metering/pkg/generated/informers/externalversions/internalinterfaces"
	v1 "github.com/bentitopolis/operator-metering/pkg/generated/listers/metering/v1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.MeteringV1().ReportDataSources(namespace).List(options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.MeteringV1().ReportDataSources(namespace).Watch(options)
			},
		},
