...
```
$GOPATH/src/github.com/bentitopolis/operator-metering
```
...
git clone https://github.com/bentitopolis/operator-metering $GOPATH/src/github.com/bentitopolis/operator-metering
```
